...
import getSegmentLabelFromCanvas from './segmentationInformation';
...
import {
  resetElementCursor,
  hideElementCursor,
} from '@cornerstonejs/tools/dist/esm/cursors/elementCursor';
import {
  AnnotationCompletedEventDetail,
  AnnotationModifiedEventDetail,
} from '@cornerstonejs/tools/dist/esm/types/EventTypes';
...
import { ProbeAnnotation } from '@cornerstonejs/tools/dist/esm/types/ToolSpecificAnnotationTypes';
import { StyleSpecifier } from '@cornerstonejs/tools/dist/esm/types/AnnotationStyle';
 ...
 *
 */
class SegmentProbeTool extends AnnotationTool {
  static toolName;
  ...
  _getTextLines(
    ...
    const { worldPos, index, Modality, value, SUVBw, SUVLbm, SUVBsa } = cachedVolumeStats;
    ...
    const segmentLabel = getSegmentLabelFromCanvas(viewport, this.toolGroupId, canvasPos);
    if (segmentLabel) {
      textLines.push(`${segmentLabel}`);
    }
    return textLines;
  }
...
SegmentProbeTool.toolName = 'SegmentProbe';
export default SegmentProbeTool;
